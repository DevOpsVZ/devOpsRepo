...
<ul id="navbar">
		  <li><a class="active" href="manager.html">Home</a></li>
...
<c:forEach var="user" items="${userList}" varStatus="status">
	<tr>
		...
		<form method="post" action="deleteUser.html" id="deleteUserForm-${user.getId()}">
...
<div id="dialog-form" title="Create new user">
  ...
  <form method="post" action="addUser.html" id="addUserForm" modelAttribute="user">
    <fieldset>
